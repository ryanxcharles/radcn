...
.radcn-alert{position:relative;display:grid;gap:.375rem;width:100%;max-width:34rem;border:1px solid var(--radcn-alert-border,var(--radcn-border));border-radius:var(--radcn-radius);padding:1rem;background:var(--radcn-alert-bg,var(--radcn-background));color:var(--radcn-alert-fg,var(--radcn-foreground));font-family:var(--radcn-font)}
.radcn-alert--destructive{--radcn-alert-border:color-mix(in srgb,var(--radcn-destructive) 40%,var(--radcn-border));--radcn-alert-fg:var(--radcn-destructive)}
.radcn-alert-title{font:600 .9375rem/1.35 var(--radcn-font)}
.radcn-alert-description{color:color-mix(in srgb,var(--radcn-alert-fg,var(--radcn-foreground)) 72%,transparent);font:400 .875rem/1.5 var(--radcn-font)}
.radcn-alert-action{margin-top:.25rem}
.radcn-aspect-ratio{display:block;width:100%;overflow:hidden;border-radius:var(--radcn-radius);background:var(--radcn-secondary)}
.radcn-aspect-ratio>*{width:100%;height:100%}
.radcn-badge{display:inline-flex;align-items:center;justify-content:center;width:fit-content;min-height:1.375rem;border:1px solid transparent;border-radius:calc(var(--radcn-radius) - .125rem);padding:.125rem .625rem;color:var(--radcn-badge-fg,var(--radcn-primary-foreground));background:var(--radcn-badge-bg,var(--radcn-primary));font:500 .75rem/1 var(--radcn-font);text-decoration:none;white-space:nowrap}
.radcn-badge--secondary{--radcn-badge-bg:var(--radcn-secondary);--radcn-badge-fg:var(--radcn-secondary-foreground)}
.radcn-badge--destructive{--radcn-badge-bg:var(--radcn-destructive);--radcn-badge-fg:var(--radcn-destructive-foreground)}
.radcn-badge--outline{--radcn-badge-bg:var(--radcn-background);--radcn-badge-fg:var(--radcn-foreground);border-color:var(--radcn-border)}
.radcn-badge--ghost{--radcn-badge-bg:transparent;--radcn-badge-fg:var(--radcn-foreground)}
.radcn-badge--link{--radcn-badge-bg:transparent;--radcn-badge-fg:var(--radcn-foreground);padding-inline:0;text-decoration:underline;text-underline-offset:.25rem}
.radcn-card{display:flex;flex-direction:column;width:min(100%,28rem);border:1px solid var(--radcn-card-border,var(--radcn-border));border-radius:calc(var(--radcn-radius) + .125rem);background:var(--radcn-card-bg,var(--radcn-background));color:var(--radcn-card-fg,var(--radcn-foreground));font-family:var(--radcn-font);box-shadow:0 1px 2px rgb(0 0 0 / .04)}
.radcn-card--sm{width:min(100%,22rem)}
.radcn-card-header{display:grid;grid-template-columns:1fr auto;gap:.75rem;padding:1.25rem 1.25rem 0}
.radcn-card-title{font:600 1rem/1.3 var(--radcn-font)}
.radcn-card-description{margin-top:.25rem;color:var(--radcn-muted-foreground);font:400 .875rem/1.45 var(--radcn-font)}
.radcn-card-content{padding:1rem 1.25rem;color:var(--radcn-foreground);font:400 .875rem/1.5 var(--radcn-font)}
.radcn-card-footer{display:flex;align-items:center;gap:.75rem;padding:0 1.25rem 1.25rem}
.radcn-empty{display:flex;min-height:13rem;width:min(100%,32rem);flex-direction:column;align-items:center;justify-content:center;gap:1.25rem;border:1px dashed var(--radcn-border);border-radius:calc(var(--radcn-radius) + .125rem);padding:2rem;text-align:center;font-family:var(--radcn-font)}
.radcn-empty-header,.radcn-empty-content{display:flex;flex-direction:column;align-items:center;gap:.75rem}
.radcn-empty-media{display:flex;width:3rem;height:3rem;align-items:center;justify-content:center;border-radius:999px;background:var(--radcn-secondary);color:var(--radcn-secondary-foreground);font:600 1rem/1 var(--radcn-font)}
.radcn-empty-media--icon{background:var(--radcn-primary);color:var(--radcn-primary-foreground)}
.radcn-empty-title{font:600 1rem/1.3 var(--radcn-font)}
.radcn-empty-description{max-width:22rem;color:var(--radcn-muted-foreground);font:400 .875rem/1.45 var(--radcn-font)}
.radcn-kbd-group{display:inline-flex;align-items:center;gap:.25rem}
.radcn-kbd{display:inline-flex;min-width:1.75rem;min-height:1.75rem;align-items:center;justify-content:center;border:1px solid var(--radcn-border);border-radius:calc(var(--radcn-radius) - .125rem);background:var(--radcn-secondary);color:var(--radcn-foreground);font:500 .75rem/1 var(--radcn-font);user-select:none}
.radcn-separator{flex-shrink:0;background:var(--radcn-border)}
.radcn-separator--horizontal{width:100%;height:1px}
.radcn-separator--vertical{width:1px;align-self:stretch}
.radcn-skeleton{border-radius:var(--radcn-radius);background:var(--radcn-skeleton-bg,var(--radcn-secondary));animation:radcn-pulse 1.5s ease-in-out infinite}
.radcn-spinner{width:var(--radcn-spinner-size,1rem);height:var(--radcn-spinner-size,1rem);animation:radcn-spin 1s linear infinite;color:var(--radcn-spinner-color,var(--radcn-foreground))}
.radcn-spinner-track{opacity:.2}
.radcn-spinner-head{opacity:.85}
@keyframes radcn-pulse{50%{opacity:.5}}
@keyframes radcn-spin{to{transform:rotate(360deg)}}
...
.radcn-fixture-custom-alert{--radcn-alert-bg:#f0fdfa;--radcn-alert-border:#0f766e;--radcn-alert-fg:#134e4a}
.radcn-fixture-custom-badge{--radcn-badge-bg:#4f46e5;--radcn-badge-fg:#fff}
...
.radcn-checkbox-wrapper,.radcn-radio-item,.radcn-switch-wrapper{position:relative;display:inline-flex;flex-shrink:0;align-items:center;justify-content:center;border:1px solid var(--radcn-control-border,var(--radcn-input));background:var(--radcn-control-bg,var(--radcn-background));color:var(--radcn-control-fg,var(--radcn-primary-foreground));outline:none;transition:border-color 120ms ease,background-color 120ms ease,box-shadow 120ms ease}
.radcn-checkbox-wrapper{width:1rem;height:1rem;border-radius:calc(var(--radcn-radius) - .1875rem)}
.radcn-checkbox-input,.radcn-radio-input,.radcn-switch-input{position:absolute;inset:0;margin:0;opacity:0;cursor:pointer}
.radcn-checkbox-wrapper:has(.radcn-checkbox-input:focus-visible),.radcn-radio-item:has(.radcn-radio-input:focus-visible),.radcn-switch-wrapper:has(.radcn-switch-input:focus-visible){border-color:var(--radcn-ring);box-shadow:0 0 0 3px color-mix(in srgb,var(--radcn-ring) 35%,transparent)}
.radcn-checkbox-wrapper:has(.radcn-checkbox-input:checked),.radcn-checkbox-wrapper[data-state="indeterminate"],.radcn-radio-item:has(.radcn-radio-input:checked),.radcn-switch-wrapper:has(.radcn-switch-input:checked){border-color:var(--radcn-control-checked-bg,var(--radcn-primary));background:var(--radcn-control-checked-bg,var(--radcn-primary))}
.radcn-checkbox-wrapper[data-invalid="true"],.radcn-radio-item[data-invalid="true"],.radcn-switch-wrapper[data-invalid="true"]{border-color:var(--radcn-control-invalid,var(--radcn-destructive));box-shadow:0 0 0 3px color-mix(in srgb,var(--radcn-control-invalid,var(--radcn-destructive)) 20%,transparent)}
.radcn-checkbox-wrapper[data-disabled="true"],.radcn-radio-item[data-disabled="true"],.radcn-switch-wrapper[data-disabled="true"]{cursor:not-allowed;opacity:.5}
.radcn-checkbox-indicator{display:grid;place-items:center;width:100%;height:100%;color:var(--radcn-control-fg,var(--radcn-primary-foreground));font:700 .6875rem/1 var(--radcn-font);pointer-events:none}
.radcn-checkbox-wrapper:has(.radcn-checkbox-input:checked) .radcn-checkbox-indicator::before{content:"x"}
.radcn-radio-group{display:grid;gap:.75rem;font-family:var(--radcn-font)}
.radcn-radio-item{width:1rem;height:1rem;border-radius:999px}
.radcn-radio-indicator{width:.375rem;height:.375rem;border-radius:999px;background:currentColor;opacity:0;pointer-events:none}
.radcn-radio-item:has(.radcn-radio-input:checked) .radcn-radio-indicator{opacity:1}
.radcn-switch-wrapper{width:2.25rem;height:1.25rem;justify-content:flex-start;border-radius:999px;padding:.125rem}
.radcn-switch-wrapper--sm{width:2rem;height:1rem}
.radcn-switch-thumb{width:.875rem;height:.875rem;border-radius:999px;background:var(--radcn-switch-thumb-bg,var(--radcn-background));box-shadow:0 1px 2px rgb(0 0 0 / .18);pointer-events:none;transition:transform 120ms ease}
.radcn-switch-wrapper--sm .radcn-switch-thumb{width:.625rem;height:.625rem}
.radcn-switch-wrapper:has(.radcn-switch-input:checked) .radcn-switch-thumb{transform:translateX(1rem)}
.radcn-switch-wrapper--sm:has(.radcn-switch-input:checked) .radcn-switch-thumb{transform:translateX(.875rem)}
.radcn-progress-wrapper{position:relative;display:block;width:min(100%,20rem);height:.5rem;overflow:hidden;border-radius:999px;background:var(--radcn-progress-bg,var(--radcn-secondary))}
.radcn-progress{position:absolute;inset:0;width:100%;height:100%;opacity:0}
.radcn-progress-track{display:block;width:100%;height:100%}
...
.radcn-slider{position:relative;display:block;width:min(100%,20rem);height:1.25rem;color:var(--radcn-slider-fg,var(--radcn-primary));font-family:var(--radcn-font)}
.radcn-slider[data-disabled="true"]{opacity:.5}
.radcn-slider-input{position:absolute;inset:0;z-index:2;width:100%;height:100%;margin:0;opacity:0;cursor:pointer}
.radcn-slider-input:disabled{cursor:not-allowed}
.radcn-slider-track{position:absolute;top:50%;left:0;right:0;display:block;height:.5rem;overflow:hidden;border-radius:999px;background:var(--radcn-slider-track-bg,var(--radcn-secondary));transform:translateY(-50%)}
.radcn-slider-range{display:block;width:var(--radcn-slider-percent,0%);height:100%;border-radius:inherit;background:var(--radcn-slider-range-bg,var(--radcn-primary))}
.radcn-slider-thumb{position:absolute;top:50%;left:var(--radcn-slider-percent,0%);z-index:1;width:1rem;height:1rem;border:2px solid var(--radcn-slider-thumb-border,var(--radcn-primary));border-radius:999px;background:var(--radcn-slider-thumb-bg,var(--radcn-background));box-shadow:0 1px 2px rgb(0 0 0 / .12);pointer-events:none;transform:translate(-50%,-50%)}
.radcn-slider:has(.radcn-slider-input:focus-visible) .radcn-slider-thumb{box-shadow:0 0 0 3px color-mix(in srgb,var(--radcn-ring) 35%,transparent)}
...
.radcn-tabs{display:grid;width:min(100%,34rem);gap:.75rem;color:var(--radcn-tabs-fg,var(--radcn-foreground));font-family:var(--radcn-font)}
.radcn-tabs--vertical{grid-template-columns:max-content minmax(0,1fr);align-items:start}
.radcn-tabs-list{display:inline-flex;width:fit-content;align-items:center;gap:.25rem;border-radius:var(--radcn-radius);background:var(--radcn-tabs-list-bg,var(--radcn-secondary));padding:.25rem}
.radcn-tabs--vertical .radcn-tabs-list{flex-direction:column;align-items:stretch}
.radcn-tabs-trigger{display:inline-flex;min-height:2rem;align-items:center;justify-content:center;border:1px solid transparent;border-radius:calc(var(--radcn-radius) - .125rem);background:transparent;color:var(--radcn-tabs-trigger-fg,var(--radcn-muted-foreground));cursor:pointer;padding:.375rem .75rem;font:500 .875rem/1 var(--radcn-font);outline:none;transition:background-color 120ms ease,color 120ms ease,box-shadow 120ms ease}
.radcn-tabs-trigger:hover{color:var(--radcn-tabs-trigger-active-fg,var(--radcn-foreground))}
.radcn-tabs-trigger:focus-visible{box-shadow:0 0 0 3px color-mix(in srgb,var(--radcn-ring) 35%,transparent)}
.radcn-tabs-trigger[data-state="active"]{background:var(--radcn-tabs-trigger-active-bg,var(--radcn-background));color:var(--radcn-tabs-trigger-active-fg,var(--radcn-foreground));box-shadow:0 1px 2px rgb(0 0 0 / .05)}
...
.radcn-avatar{position:relative;display:inline-flex;width:var(--radcn-avatar-size,2.5rem);height:var(--radcn-avatar-size,2.5rem);flex-shrink:0;align-items:center;justify-content:center;overflow:hidden;border-radius:999px;background:var(--radcn-avatar-bg,var(--radcn-secondary));color:var(--radcn-avatar-fg,var(--radcn-secondary-foreground));font:600 .875rem/1 var(--radcn-font);user-select:none}
.radcn-avatar::after{content:"";position:absolute;inset:0;border:1px solid var(--radcn-avatar-border,var(--radcn-border));border-radius:inherit;pointer-events:none}
.radcn-avatar--sm{--radcn-avatar-size:2rem;font-size:.75rem}
.radcn-avatar--lg{--radcn-avatar-size:3rem;font-size:1rem}
.radcn-avatar-image{position:absolute;inset:0;z-index:1;width:100%;height:100%;object-fit:cover}
.radcn-avatar-fallback{display:flex;width:100%;height:100%;align-items:center;justify-content:center;background:var(--radcn-avatar-fallback-bg,var(--radcn-secondary));color:var(--radcn-avatar-fallback-fg,var(--radcn-secondary-foreground))}
.radcn-avatar-badge{position:absolute;right:0;bottom:0;z-index:2;display:inline-flex;width:var(--radcn-avatar-badge-size,.625rem);height:var(--radcn-avatar-badge-size,.625rem);align-items:center;justify-content:center;border:2px solid var(--radcn-background);border-radius:999px;background:var(--radcn-avatar-badge-bg,#16a34a);color:var(--radcn-avatar-badge-fg,#fff)}
.radcn-avatar--sm .radcn-avatar-badge{--radcn-avatar-badge-size:.5rem}
.radcn-avatar--lg .radcn-avatar-badge{--radcn-avatar-badge-size:.75rem}
.radcn-avatar-group{display:flex;align-items:center;isolation:isolate}
.radcn-avatar-group>.radcn-avatar,.radcn-avatar-group>.radcn-avatar-group-count{margin-left:-.5rem;box-shadow:0 0 0 2px var(--radcn-background)}
.radcn-avatar-group>.radcn-avatar:first-child,.radcn-avatar-group>.radcn-avatar-group-count:first-child{margin-left:0}
.radcn-avatar-group-count{display:inline-flex;width:2.5rem;height:2.5rem;align-items:center;justify-content:center;border-radius:999px;background:var(--radcn-avatar-count-bg,var(--radcn-secondary));color:var(--radcn-avatar-count-fg,var(--radcn-secondary-foreground));font:600 .8125rem/1 var(--radcn-font)}
.radcn-scroll-area{position:relative;width:min(100%,24rem);height:var(--radcn-scroll-area-height,12rem);overflow:hidden;border:1px solid var(--radcn-scroll-area-border,var(--radcn-border));border-radius:var(--radcn-radius);background:var(--radcn-scroll-area-bg,var(--radcn-background));color:var(--radcn-scroll-area-fg,var(--radcn-foreground));font-family:var(--radcn-font)}
.radcn-scroll-area-viewport{width:100%;height:100%;overflow:auto;border-radius:inherit;padding:1rem;outline:none;scrollbar-color:var(--radcn-scroll-area-thumb-bg,var(--radcn-border)) transparent;scrollbar-width:thin}
.radcn-scroll-area-viewport:focus-visible{box-shadow:inset 0 0 0 3px color-mix(in srgb,var(--radcn-ring) 35%,transparent)}
.radcn-scroll-area-scrollbar{position:absolute;display:flex;border-radius:999px;background:var(--radcn-scroll-area-scrollbar-bg,transparent);padding:.125rem;pointer-events:none}
.radcn-scroll-area-scrollbar--vertical{top:.25rem;right:.25rem;bottom:.25rem;width:.625rem}
.radcn-scroll-area-scrollbar--horizontal{right:.25rem;bottom:.25rem;left:.25rem;height:.625rem}
.radcn-scroll-area-thumb{display:block;flex:1;border-radius:inherit;background:var(--radcn-scroll-area-thumb-bg,var(--radcn-border))}
.radcn-scroll-area-scrollbar--vertical .radcn-scroll-area-thumb{min-height:2rem}
.radcn-scroll-area-scrollbar--horizontal .radcn-scroll-area-thumb{min-width:2rem}
.radcn-scroll-area-corner{position:absolute;right:.25rem;bottom:.25rem;width:.625rem;height:.625rem;border-radius:999px;background:var(--radcn-scroll-area-corner-bg,var(--radcn-border));pointer-events:none}
.radcn-dialog{display:contents;font-family:var(--radcn-font)}
.radcn-dialog-trigger{display:inline-flex;min-height:var(--radcn-control-height);align-items:center;justify-content:center;border:1px solid transparent;border-radius:var(--radcn-radius);background:var(--radcn-dialog-trigger-bg,var(--radcn-primary));color:var(--radcn-dialog-trigger-fg,var(--radcn-primary-foreground));cursor:pointer;padding:.5rem 1rem;font:500 .875rem/1 var(--radcn-font);outline:none}
.radcn-dialog-trigger:focus-visible,.radcn-dialog-close:focus-visible{box-shadow:0 0 0 3px color-mix(in srgb,var(--radcn-ring) 35%,transparent)}
.radcn-dialog-portal{position:fixed;inset:0;z-index:var(--radcn-dialog-z,50)}
.radcn-dialog-overlay{position:fixed;inset:0;background:var(--radcn-dialog-overlay-bg,rgb(0 0 0 / .5));animation:radcn-dialog-fade-in 120ms ease-out}
.radcn-dialog-content{position:fixed;top:50%;left:50%;z-index:1;display:grid;width:min(calc(100vw - 2rem),var(--radcn-dialog-width,32rem));gap:1rem;border:1px solid var(--radcn-dialog-border,var(--radcn-border));border-radius:calc(var(--radcn-radius) + .125rem);background:var(--radcn-dialog-bg,var(--radcn-background));color:var(--radcn-dialog-fg,var(--radcn-foreground));padding:1.5rem;box-shadow:0 24px 64px rgb(0 0 0 / .2);outline:none;transform:translate(-50%,-50%);animation:radcn-dialog-zoom-in 120ms ease-out}
.radcn-dialog-header{display:grid;gap:.375rem}
.radcn-dialog-footer{display:flex;flex-direction:row-reverse;gap:.5rem}
.radcn-dialog-title{margin:0;font:600 1.125rem/1.25 var(--radcn-font)}
...
.radcn-fixture-custom-slider{--radcn-slider-track-bg:#ccfbf1;--radcn-slider-range-bg:#0f766e;--radcn-slider-thumb-border:#0f766e;--radcn-slider-thumb-bg:#f0fdfa}
